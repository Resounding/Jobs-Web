...
define('resources/services/auth',["require", "exports", 'aurelia-framework', 'aurelia-event-aggregator', 'aurelia-router', 'aurelia-fetch-client', './config', './log', "aurelia-router"], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, aurelia_router_1, aurelia_fetch_client_1, config_1, log_1, aurelia_router_2) {
    "use strict";
    ...
    var AuthorizeStep = (function () {
        ...
        AuthorizeStep.prototype.run = function (navigationInstruction, next) {
            if (navigationInstruction.getAllInstructions().some(function (i) { return i.config.auth; })) {
                ...
                if (!loggedIn) {
                    return next.cancel(new aurelia_router_2.Redirect('login'));
                }
            }
            return next();
        };
    ...
    var App = (function () {
        ...
        App.prototype.configureRouter = function (config, router) {
            ...
            config.map([
                ...
                { route: 'jobs/new', name: 'jobs.new', moduleId: 'resources/views/jobs/new', title: 'New Job', nav: true, auth: true },
                { route: 'jobs/:id', name: 'jobs.edit', moduleId: 'resources/views/jobs/edit', title: 'Edit Job', auth: true }
            ]);
            this.router = router;
        };
        return App;
...
define('resources/views/controls/nav-bar',["require", "exports", 'aurelia-framework', 'aurelia-router', '../../services/auth'], function (require, exports, aurelia_framework_1, aurelia_router_1, auth_1) {
    ...
    var NavBar = (function () {
        ...
        NavBar.prototype.attached = function () {
            var $fixedMenu = $('#fixed-menu', this.element), $mainMenu = $('#main-menu', this.element);
            $mainMenu.visibility({
                once: false,
                onBottomPassed: function () { return $fixedMenu.transition('fade in'); },
                onBottomPassedReverse: function () { return $fixedMenu.transition('fade out'); }
            });
...
define('resources/views/jobs/edit',["require", "exports", "aurelia-framework", "aurelia-router", '../../services/data/job-service', '../../services/data/customer-service', '../../services/data/activities-service', '../../services/notifications', '../../models/job-type', '../../models/job-status', "../../models/billing-type", "../../models/work-type"], function (require, exports, aurelia_framework_1, aurelia_router_1, job_service_1, customer_service_1, activities_service_1, notifications_1, job_type_1, job_status_1, billing_type_1, work_type_1) {
    "use strict";
        ...
        ListItem.prototype.attached = function () {
            ...
            $('.calendar', this.element).calendar({
                ...
                onChange: function (date) {
                    _this.job.startDate = moment(date).toDate();
                    _this.save('Start Date');
                }
            });
...
define('resources/views/jobs/list',["require", "exports", 'aurelia-framework', 'aurelia-event-aggregator', '../../services/auth', '../../services/log', '../../services/data/db', '../../models/job-status', '../../services/data/job-service', './close-job'], function (require, exports, aurelia_framework_1, aurelia_event_aggregator_1, auth_1, log_1, db_1, job_status_1, job_service_1, close_job_1) {
    ...
    var JobList = (function () {
        function JobList(element, auth, jobService, events) {
            ...
            this.myJobs = this.auth.isInRole(auth_1.Roles.Foreman);
            this.refresh();
        ...
        JobList.prototype.filter = function () {
            ...
            var sameDay = function (i) { return moment(i.startDate).isSame(moment(), 'day'); };
            var thisWeek = function (i) { return moment(i.startDate).isBefore(moment().startOf('week').add(1, 'week')); };
            ...
            var future = function (i) { return moment(i.startDate).isAfter(moment().startOf('week').add(1, 'week')); };
            log_1.log.debug("Only show my jobs: " + this.myJobs);
            log_1.log.debug("Show completed jobs: " + this.showCompleted);
            this.todaysItems = _.filter(this.items, function (i) { return sameDay(i) && mine(i) && completed(i); });
            this.weekItems = _.filter(this.items, function (i) { return thisWeek(i) && !sameDay(i) && mine(i) && completed(i); });
            this.futureItems = _.filter(this.items, function (i) { return future(i) && mine(i) && completed(i); });
            this.unscheduled = _.filter(this.items, function (i) { return !i.startDate && mine(i) && completed(i); });
        };
...
define('resources/views/jobs/new',["require", "exports", "aurelia-framework", "aurelia-router", '../../services/data/job-service', '../../services/data/customer-service', '../../services/data/activities-service', '../../services/notifications', '../../models/job', '../../models/customer', '../../models/job-type', '../../models/job-status', "../../models/billing-type", "../../models/work-type"], function (require, exports, aurelia_framework_1, aurelia_router_1, job_service_1, customer_service_1, activities_service_1, notifications_1, job_1, customer_1, job_type_1, job_status_1, billing_type_1, work_type_1) {
    "use strict";
    var NewJob = (function () {
        function NewJob(element, router, jobService, customerService, activitiesService) {
            var _this = this;
            this.element = element;
            this.router = router;
            this.jobService = jobService;
        ...
        Object.defineProperty(NewJob.prototype, "customer_id", {
            ...
            set: function (id) {
                var customer = _.find(this.customers, function (c) { return c._id === id; });
