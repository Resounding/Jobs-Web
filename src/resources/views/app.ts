...
export class App {
    ...
    configureRouter(config:RouterConfiguration, router:Router) {
        ...
        config.map([
            ...
            {route: 'job-phases', name: 'job.phases.list', moduleId: 'resources/views/job-phases/list', title: 'Job Phases', nav: true, auth: true, settings: { icon: 'tasks', hideMobile: true }},
        ]);
