...
function getIcons():string[] {
  return [
    ...
    'file.audio.outline',
    'file.video.outline',
    'file.code.outline',    /* Technologies */
    'qrcode',
    'barcode',
    'rss',
    'fork',
    ...
    'stop.circle',
    'stop.circle.outline',    /* Map, Locations, & Transportation */
    'marker',
    'coffee',
    'food',
    'building.outline',
    ...
    'sort.numeric.descending',    /* Text Editor */
    'font',
    'bold',
    'italic',
    'text.height',
